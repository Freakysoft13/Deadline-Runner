...
public class ParallaxChainSpawn : MonoBehaviour {
	...
	protected void SelectNextObject()
	{
		...
		if (selfRespawnChace > selfChance)
		{
			...
			nextObject.GetComponent<ParallaxChainSpawn>().selfRespawnChace -= selfDiminishingReturn;
			return;
		}
	...
	public IEnumerator SpawnNextIn() {
